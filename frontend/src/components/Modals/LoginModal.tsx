...
function LoginModal() {
  ...
  return (
    <div
      className={`w-screen h-screen bg-[#222226] fixed top-0 left-0 z-50 flex justify-center items-center bg-opacity-80 backdrop-filter backdrop-blur-sm ${
        visible ? "block" : "hidden"
      }`}
    >
      <div className="flex flex-col gap-2 p-3 w-max bg-[#151718] rounded-md">
        <div
        ...
        <div className="flex flex-col gap-8 items-center pt-2 pb-10 px-9">
          <h1 className="font-opsans font-bold text-sm md:text-xl text-white">
            Connect a Wallet
          </h1>
          ...
          <p className="font-opsans text-white">
            You can't wait?{" "}
